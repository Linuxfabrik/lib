...
# Everything from here is just a workaround to solve the annoying encoding problems of the
# Python 2 plugins even after their EOL. For Python 3, we moved all below to a new txt3 library
# and adapted all other depended libraries accordingly.
# The code is from /usr/lib/python3.10/site-packages/ansible/module_utils/_text.py
