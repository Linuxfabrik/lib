...
* kvm.py: new module for libvirt hosts, covering domain statistics and listings, storage pools and their volumes, and the names of domain states and their reasons. It connects read-only, so it needs neither root nor sudo
